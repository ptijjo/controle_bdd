...
export class MailService {
  public async sendEmail(email: string, subject: string, content: string, link: string, disclaimer: string): Promise<string> {
      ...
      Messages: [
        {
          ...
          Subject: subject,
          TextPart: '',
          HTMLPart: await this.getTemplate(content, subject, link, disclaimer),
        },
      ],
    });
